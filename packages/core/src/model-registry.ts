...
const GEMINI_36_FLASH_ROUTES = {
  ...
  geminiCliFallbackModel: "gemini-3.6-flash-medium",
}
...
export function getGemini36FlashAntigravityModel(tier?: ThinkingTier): string {
  if (!tier) {
    return GEMINI_36_FLASH_ROUTES.antigravity.defaultModel
  }
  return GEMINI_36_FLASH_ROUTES.antigravity.byTier[tier] ?? GEMINI_36_FLASH_ROUTES.antigravity.defaultModel
}

export function getGemini36FlashGeminiCliFallbackModel(): string {
  return GEMINI_36_FLASH_ROUTES.geminiCliFallbackModel
}
